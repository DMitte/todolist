<template lang="es">
    <div class="BarNavegation">
        <button class="btn-toggle" @click="toggleNav"><img src="@/assets/iconos/btn-abrir.svg" alt="btn"></button>
        <button class="btn-notify"><img src="@/assets/iconos/btn-notify.svg" alt="btn notify"></button>

        <nav v-bind:class="{isActive: navActive}">
...
@import url('https://fonts.googleapis.com/css2?family=Ubuntu:wght@300;400;500;700&display=swap');
    ...
    nav.isActive{
        display: block;
        animation: abrir 0.5s linear 0s;
